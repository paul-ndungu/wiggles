            ...
            <div class="bread-inner">
              <div class="bread-menu">
                <ul>
                  ...
                  <li><a href="#">About WigglesTechnology</a></li>
                </ul>
              </div>
              <div class="bread-title">
                <h2>Innovative mind technical brilliance measurable results</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-6 v-center">
          <div class="about-image">
            <img src="<?=yii::$app->request->baseUrl;?>/images/about/company-about.png" alt="about us" class="img-fluid"/>
          </div>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row upset">
        <div class="col-lg-3 col-sm-6 mt30">
          <div class="s-block up-hor">
            <div class="s-card-icon"><img src="<?=yii::$app->request->baseUrl;?>/images/icons/research.svg" alt="service" class="img-fluid"/></div>
        ...
        <div class="col-lg-3 col-sm-6 mt30">
          <div class="s-block up-hor">
            <div class="s-card-icon"><img src="<?=yii::$app->request->baseUrl;?>/images/icons/chat.svg" alt="service" class="img-fluid"/></div>
        ...
        <div class="col-lg-3 col-sm-6 mt30">
          <div class="s-block up-hor">
            <div class="s-card-icon"><img src="<?=yii::$app->request->baseUrl;?>/images/icons/monitor.svg" alt="service" class="img-fluid"/></div>
        ...
        <div class="col-lg-3 col-sm-6 mt30">
          <div class="s-block up-hor">
            <div class="s-card-icon"><img src="<?=yii::$app->request->baseUrl;?>/images/icons/trasparency.svg" alt="service" class="img-fluid"/></div>
