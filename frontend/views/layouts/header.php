 ...
 ?>  	
		<div class="onloadpage" id="page_loader">
			<div class="pre-content">
				<div class="logo-pre"><img src="<?=Yii::$app->request->baseUrl;?>/images/logo.png" alt="Logo" class="img-fluid" /></div>
			...
			<div class="container-fluid m-pad">
				<div class="menu-header">
					<div class="dsk-logo"><a class="nav-brand" href="digital-agency.html">
						<img src="<?=Yii::$app->request->baseUrl;?>/images/white-logo.png" alt="Logo" class="mega-white-logo"/>
						<img src="<?=Yii::$app->request->baseUrl;?>/images/logo.png" alt="Logo" class="mega-darks-logo"/>
					</a></div>
					<div class="custom-nav" role="navigation">
						<ul class="nav-list">
							<li><a href="<?=Url::to(['site/index']);?>" class="menu-links">Home</a>
							
						<li><a href="<?=Url::to(['/about/about']);?>" class="menu-links">About</a>
				...
				<div class="nx-dropdown menu-dorpdown">
					<div class="sub-menu-section"><div class="sub-menu-center-block">
						<div class="sub-menu-column smfull">
							<ul>
								<li><a href="<?=Url::to(['/portfolio/portfoliogrid']);?>">Enterprise Software Development</a> </li>
								<li><a href="<?=Url::to(['/portfolio/portfoliogrid2']);?>">Full Start Web Development</a> </li>
								<li><a href="<?=Url::to(['/portfolio/portfoliowide']);?>">Mobile App Development</a> </li>
								<li><a href="<?=Url::to(['/portfolio/portfoliodetails']);?>">App Migration & Legacy Modernization Services</a> </li>
							</ul>
						</div>
					</div>
				</div>
		...
		<li ><a href="<?=Url::to(['/portfolio/portfoliodetails']);?>" class="menu-links">Portfolio</a></li>
		<li ><a href="<?=Url::to(['/contacts/contacts'])?>" class="menu-links">Contacts</a></li>
...
<div class="contact-inquiry">
	<div class="contact-info-">
		...
		<div class="inquiry-card-nn hrbg">
			...
			<ul><li class="mb0"><img src="<?=Yii::$app->request->baseUrl;?>/images/flags/us.svg" alt="us office" class="flags-size"> <a href="tel:1111111111" >+1-123-456-7890</a></li></ul>
		</div>
		<div class="inquiry-card-nn">
			<div class="title-inq-c">FOR SALES DEPARTMENT</div>
			<ul><li><a href="tel:1111111111"><img src="<?=yii::$app->request->baseUrl;?>/images/flags/us.svg" alt="us office" class="flags-size"> +1-123-456-7890</a></li>
			<li><a href="tel:1111111111"><img src="<?=Yii::$app->request->baseUrl;?>/images/flags/au.svg" alt="australia office" class="flags-size"> +1-123-456-7890</a></li>
